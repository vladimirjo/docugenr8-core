...
class Paragraph:
    def __init__(
        ...
        self._space_before: float = (
            textarea._document.settings.paragraph_space_before)
        self._space_after: float = (
        ...
        self._hanging_indent: float = (
            textarea._document.settings.paragraph_hanging_indent)
        self._left_indent: float = (
            textarea._document.settings.paragraph_left_indent)
        self._right_indent: float = (
            textarea._document.settings.paragraph_right_indent)
    ...
    def _get_first_linked_paragraph(
        ...
        while first_linked_paragraph._prev_linked_paragraph is not None:
            first_linked_paragraph = (
                first_linked_paragraph._prev_linked_paragraph)
